      ...
      <div className="feedback-container">
        ...
        {finalAssessment && (
          <div className="feedback-callout feedback-callout-blue">
            ...
            <p className="feedback-assessment-text">{renderTextWithBold(finalAssessment)}</p>
          </div>
        )}

        <div className="feedback-device-limit-row">
          <p className="feedback-device-limit-text">
            Device interview attempts: {deviceAttempts}/{DEVICE_INTERVIEW_LIMIT}.{' '}
            {deviceAttempts >= DEVICE_INTERVIEW_LIMIT
              ? 'No more interview retakes can be started from this device.'
